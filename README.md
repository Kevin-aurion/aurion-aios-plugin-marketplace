...
The Plugin connects only to https://aurion-aios-mcp.aurion-group.com/mcp. Installation does not grant AIOS access; every user must still authenticate with an enabled AIOS account through OAuth.
